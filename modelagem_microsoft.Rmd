...
## Cross-Validation
# 
# x = df_tsible$log_retorno_dif[0:101]
# 
# 
# far2 = function(x, h){
...
# }
# 
# tsCV(x, forecastfunction = far2, h = 2, window = 8)
...
fit1 = ugarchfit(spec1, df_tsible, solver = 'hybrid', out.sample = nrow(df_tsible)-4000)
fore1 = ugarchforecast(fit1, data = df_tsible, n.ahead = 1, n.roll = nrow(df_tsible)-4000)
